...
function loadStats() {
  clearInputs();
  document.getElementById("nba-breakdown")?.classList.add("hidden");
  document.getElementById("mlb-hitter-breakdown")?.classList.add("hidden");
  document.getElementById("nfl-offense-breakdown")?.classList.add("hidden");
